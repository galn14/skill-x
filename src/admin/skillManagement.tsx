...
const skillManagement: React.FC = () => {
  const [selectedItem, setSelectedItem] = useState<string>('Skill Approval'); // Track selected item
        ...
        <div style={{ display: 'flex', position: 'relative' }}>
          ...
          <AppBar
            ...
            style={{
              ...
              width: sidebarOpen ? 'calc(100% - 275px)' : '100%', // Dynamic width
              marginLeft: sidebarOpen ? '250px' : '0', // Adjust based on sidebar visibility
              zIndex: 110,
            }}
          >
          ...
          >
            ...
            >
              ...
              <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}> {/* Wrap for smaller screens */}
                ...
                <TextField label="Search skill" variant="outlined" size="small" />
              </Box>
            </Box>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 2 }}>
                  {skills.map((skillItem) => (
                    <Card key={skillItem.id} sx={{ display: 'flex', alignItems: 'center', p: 2, bgcolor: '#ffffff', boxShadow: 1 }}>
